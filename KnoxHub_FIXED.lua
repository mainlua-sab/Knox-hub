...
DiscordBtn.Position=UDim2.new(1,-110,0.5,-10)
...
DiscordTip.Position=UDim2.new(1,-228,0.5,-9)
...
SettingsBtn.Text="Settings & Sky Themes"
...
local function createSettingsGui()
    ...
    scaleLbl.Size = UDim2.new(0.4, 0, 1, 0)
    ...
    local scaleSlider = Instance.new("Frame", scaleRow)
    scaleSlider.Size = UDim2.new(0, 80, 0, 4)
    scaleSlider.Position = UDim2.new(0.5, 0, 0.5, -2)
    ...
    scaleKnob.Size = UDim2.new(0, 8, 0, 8)
    scaleKnob.Position = UDim2.new(0.75, -4, 0.5, -4)
    ...
    scaleVal.Size = UDim2.new(0.15, 0, 1, 0)
    scaleVal.Position = UDim2.new(1, -35, 0, 0)
    scaleVal.BackgroundTransparency = 1
    scaleVal.Text = "1.0"
    scaleVal.TextSize = 10
...
SettingsBtn.MouseButton1Click:Connect(createSettingsGui)
