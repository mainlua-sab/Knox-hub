...
-- Main GUI Gradient Background (Black to Blue)
...
local WinBGGradient=Instance.new("UIGradient")
WinBGGradient.Color=ColorSequence.new({
...
WinBGGradient.Rotation=135
WinBGGradient.Parent=WinBG
